...
public class LeComptoirDuHardware {
			...
			public LeComptoirDuHardware() 
			{
				this.lien = null;
				this.date = new Date(System.currentTimeMillis());
				this.sdf = new SimpleDateFormat( "dd/MM/yy H:mm:ss" );
				this.origine = "Le Comptoir du Hardware";
				this.titre = null;
			...
			public void getInfo(String nom_bdd, String user_bdd, String pass_bdd) throws IOException
			{
						...
						xml = Jsoup.connect("http://www.comptoir-hardware.com/home.xml").get().toString();
		...
		//*****************R�cuperation des informations de base****************************
						...
						for(int i=0;i<Main.nbInfos; i++)
						{
							...
							//Nettoyage du titre
							this.titre = this.titre.substring(9, this.titre.length()-3);
